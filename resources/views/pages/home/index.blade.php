                        ...
                        <div class="productinfo text-center">
                            ...
                            <form action="{{ URL::to('/save-cart') }}" method="POST">
                                ...
                                <button type="button" class="btn btn-primary btn-sm add-to-cart"
                                    data-id_product="{{ $product->id }}" name="add-to-cart">Add to Cart</button>
                            </form>
                        </div>
        ...
        $(document).ready(function() {
            $('.add-to-cart').click(function() {
                ...
                if (parseInt(cart_product_qty) > parseInt(cart_product_quantity)) {
                    alert('Please choose smaller quantity than ' + cart_product_quantity);
                } else {
                    $.ajax({
                        ...
                        success: function(data) {
                            swal({
                                    ...
                                    text: "You can continue to add products or go to Cart",
