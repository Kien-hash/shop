                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($category->status == 0)
                                        <a href="{{ URL::to('admin/category/inactive/' . $category->id) }}"><span
                                                class="fa-thumb-styling fa fa-thumbs-up"></span></a>
                                    @else
                                        <a href="{{ URL::to('admin/category/active/' . $category->id) }}"><span
                                ...
                                <td>
                                    ...
                                    <a onclick="return confirm('Are you sure you want to delete this category?')"
                                        href="{{ URL::to('admin/category/delete/' . $category->id) }}"
                                        class="active styling-edit" ui-toggle-class="">
