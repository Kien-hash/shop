            ...
            <div class="table-responsive">
                <table class="table table-striped b-t b-light">
                    ...
                    <tbody>
                        ...
                        <td>
                            <a href="{{ URL::to('admin/product/edit/' . $product->id) }}" class="active styling-edit"
                                ui-toggle-class="">
                                <i class="fa fa-pencil-square-o text-success text-active"></i></a>
                            <a onclick="return confirm('Are you sure you want to delete this product?')"
                                href="{{ URL::to('admin/product/delete/' . $product->id) }}" class="active styling-edit"
                                ui-toggle-class="">
            ...
            <footer class="panel-footer">
                <div class="row">
                    ...
                    <div class="col-sm-5 text-center">
                        <small class="text-muted inline m-t-sm m-b-sm">showing {{ $products->currentPage() }} of
                            {{ $products->total() }} items</small>
                    </div>
                </div>
            </footer>
        </div>
